...
\titulo{Caracterizacion de montes frutales a traves del analisis de imágenes satelitales} 
...
de observación de la Tierra que son consistentes, repetitivos y de amplia cobertura, lo cual es esencial para un monitoreo efectivo. 
...
la evolución de los árboles, especificamente el progreso de las etapas de floración y maduración de los frutos.  
...
El proyecto incluye:
\begin{itemize}
	\item Evaluar las diferentes fuentes de datos y determinar cuál es la opción mas viable para la realización de este trabajo.
	\item Determinar el progreso de las etapas de floración y maduración de los frutos en el árbol.
	\item Desarrollo de herramienta de fácil acceso para el equipo de INTA.
	\item Elaboración de un informe que detalle el procedimiento realizado y resultados.
\end{itemize}

Los siguientes elementos quedan fuera del alcance:
\begin{itemize}
	\item Desarrollo de interfaz para el sistema. 	
	\item Despliegue de la solución en producción.
\end{itemize}
...
\begin{itemize}
	\item Se contará con imagenes satelitales y el set de datos con fechas de floración y cosecha 
